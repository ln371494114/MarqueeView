...
+ (NSString *)timeSegmentText:(int)seg;
{
    return [NSString stringWithFormat:@"%02d:%02d", seg / 2, seg % 2 == 0 ? 0 : 30];
}

+ (NSString *)getYearMonthFromDateComponents:(NSDateComponents *)dateComps
{
    
    return [NSString stringWithFormat:@"%02d-%02d-%02d", (int)dateComps.year, (int)dateComps.month, (int)dateComps.day];
}
